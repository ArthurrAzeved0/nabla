...
const MECANICA_2012 = [
  ...
  { id: "FISC0017", codigo: "FISC0017", nome: "Mecânica dos Fluidos",
    ...
    nota: "O conteúdo de fluidos é o mesmo; a transferência de calor, que em Fenômenos de Transporte vem na 2ª unidade, aqui é a cadeira Transmissão de Calor, do 6º período.",
    cadeira: "fentransporte" },
...
const ELETRONICA_2020 = [
  ...
  { id: "FENTR", codigo: "—", nome: "Introdução aos Fenômenos de Transporte",
    ...
    co: ["EQDIF", "ONDTERM"], cadeira: "fentransporte" },
  { id: "ELMAG1", codigo: "—", nome: "Eletromagnetismo 1",
